...
function estimateTime(value) {
  ...
  if (value.match(/^[0-9]+$/)) {
    ...
    switch (true) {
      ...
      case (pwLength == 16): result = { timeValue: '3000',      unitValue: 'years',   level: 3 }; break
      case (pwLength == 17): result = { timeValue: '69000',     unitValue: 'years',   level: 3 }; break
      case (pwLength == 18): result = { timeValue: '2',         unitValue: 'Million years',   level: 4 }; break
    }
    ...
    switch (true) {
      ...
      case (pwLength == 13): result = { timeValue: '1000',      unitValue: 'years',   level: 3 }; break
      case (pwLength == 14): result = { timeValue: '64000',     unitValue: 'years',   level: 3 }; break
      case (pwLength == 15): result = { timeValue: '3',         unitValue: 'Million years',   level: 4 }; break
      case (pwLength == 16): result = { timeValue: '173',       unitValue: 'Million years',   level: 4 }; break
      case (pwLength == 17): result = { timeValue: '9',         unitValue: 'Billion years',   level: 4 }; break
      case (pwLength == 18): result = { timeValue: '467',       unitValue: 'Billion years',   level: 4 }; break
    }
    ...
    switch (true) {
      ...
      case (pwLength == 12): result = { timeValue: '200',       unitValue: 'years',   level: 3 }; break
      case (pwLength == 13): result = { timeValue: '12000',     unitValue: 'years',   level: 3 }; break
      case (pwLength == 14): result = { timeValue: '750000',    unitValue: 'years',   level: 4 }; break
      case (pwLength == 15): result = { timeValue: '46',        unitValue: 'Million years',   level: 4 }; break
      case (pwLength == 16): result = { timeValue: '3',         unitValue: 'Billion years',   level: 4 }; break
      case (pwLength == 17): result = { timeValue: '179',       unitValue: 'Billion years',   level: 4 }; break
      case (pwLength == 18): result = { timeValue: '11',        unitValue: 'Trillion years',  level: 4 }; break
    }
    ...
    switch (true) {
      ...
      case (pwLength == 12): result = { timeValue: '3000',      unitValue: 'years',   level: 3 }; break
      case (pwLength == 13): result = { timeValue: '202000',    unitValue: 'years',   level: 4 }; break
      case (pwLength == 14): result = { timeValue: '16',        unitValue: 'Million years',   level: 4 }; break
      case (pwLength == 15): result = { timeValue: '1',         unitValue: 'Billion years',   level: 4 }; break
      case (pwLength == 16): result = { timeValue: '92',        unitValue: 'Billion years',   level: 4 }; break
      case (pwLength == 17): result = { timeValue: '7',         unitValue: 'Trillion years',  level: 4 }; break
      case (pwLength == 18): result = { timeValue: '438',       unitValue: 'Trillion years',  level: 4 }; break
    }
  } else {
...
function displayValue(result) {
  switch (result.level) {
    ...
    case 3: time.style.color = unit.style.color = '#d1a346'; break
